...
probe_duration_scale="$(_mfx_core_http_automation_parse_path_scalar_field "$profile_probe_file" "config_basis" "test_tuning" "duration_scale")"
probe_size_scale="$(_mfx_core_http_automation_parse_path_scalar_field "$profile_probe_file" "config_basis" "test_tuning" "size_scale")"
probe_opacity_scale="$(_mfx_core_http_automation_parse_path_scalar_field "$profile_probe_file" "config_basis" "test_tuning" "opacity_scale")"
probe_trail_throttle_scale="$(_mfx_core_http_automation_parse_path_scalar_field "$profile_probe_file" "config_basis" "test_tuning" "trail_throttle_scale")"
...
state_duration_scale="$(_mfx_core_http_automation_parse_path_scalar_field "$state_file" "effects_profile" "config_basis" "test_tuning" "duration_scale")"
state_size_scale="$(_mfx_core_http_automation_parse_path_scalar_field "$state_file" "effects_profile" "config_basis" "test_tuning" "size_scale")"
state_opacity_scale="$(_mfx_core_http_automation_parse_path_scalar_field "$state_file" "effects_profile" "config_basis" "test_tuning" "opacity_scale")"
state_trail_throttle_scale="$(_mfx_core_http_automation_parse_path_scalar_field "$state_file" "effects_profile" "config_basis" "test_tuning" "trail_throttle_scale")"
