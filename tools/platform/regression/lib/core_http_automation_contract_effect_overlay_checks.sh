...
_mfx_core_http_automation_contract_effect_overlay_checks() {
    ...
    mfx_assert_file_contains "$tmp_dir/effect-render-profile-probe.out" "\"click\":{\"normalized_type\":" "core effect render profile probe click command sample"
    mfx_assert_file_contains "$tmp_dir/effect-render-profile-probe.out" "\"trail\":{\"emit\":" "core effect render profile probe trail command sample"
    mfx_assert_file_contains "$tmp_dir/effect-render-profile-probe.out" "\"trail_emission\":{\"should_emit\":" "core effect render profile probe trail emission sample"
    mfx_assert_file_contains "$tmp_dir/effect-render-profile-probe.out" "\"scroll\":{\"emit\":" "core effect render profile probe scroll command sample"
    mfx_assert_file_contains "$tmp_dir/effect-render-profile-probe.out" "\"hover\":{\"normalized_type\":" "core effect render profile probe hover command sample"
    mfx_assert_file_contains "$tmp_dir/effect-render-profile-probe.out" "\"hold\":{\"start\":" "core effect render profile probe hold command sample"
