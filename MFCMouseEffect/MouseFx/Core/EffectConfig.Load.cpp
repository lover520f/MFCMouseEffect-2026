...
Argb GetColorOr(const json& j, const char* key, Argb defaultValue) {
...
void ApplyCommonInputIndicatorFields(const json& input, InputIndicatorConfig& config) {
...
void ParseInputIndicator(const json& root, EffectConfig& config) {
...
void ParseTrailParams(const json& root, EffectConfig& config) {
...
void ParseTrailProfiles(const json& root, EffectConfig& config) {
...
void ParseRippleEffect(const json& effects, EffectConfig& config) {
...
void ParseTrailEffect(const json& effects, EffectConfig& config) {
...
void ParseIconEffect(const json& effects, EffectConfig& config) {
...
void ParseTextEffect(const json& effects, EffectConfig& config) {
...
void ParseEffects(const json& root, EffectConfig& config) {
