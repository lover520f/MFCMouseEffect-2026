...
std::string WebSettingsServer::BuildStateJson() const {
    ...
    out["gpu_present_host"] = {
        ...
        {"control_on_file_present", gpuPresentHost.controlOnFilePresent},
        {"control_off_file_present", gpuPresentHost.controlOffFilePresent},
        {"control_auto_off_file_present", gpuPresentHost.controlAutoOffFilePresent},
        {"control_visible_trial_file_present", gpuPresentHost.controlVisibleTrialFilePresent},
        {"control_once_file_present", gpuPresentHost.controlOnceFilePresent},
