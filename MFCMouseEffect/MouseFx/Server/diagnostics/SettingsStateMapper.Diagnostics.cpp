...
json BuildMouseCompanionRuntimeState(const AppController* controller) {
    ...
    out["real_renderer_preview"] = {
        ...
        {"scene_runtime_model_asset_node_occupancy_state",
         realRendererPreviewDiagnostics.sceneRuntimeModelAssetNodeOccupancyState},
        {"scene_runtime_model_asset_node_occupancy_entry_count",
         realRendererPreviewDiagnostics.sceneRuntimeModelAssetNodeOccupancyEntryCount},
        {"scene_runtime_model_asset_node_occupancy_resolved_entry_count",
         realRendererPreviewDiagnostics.sceneRuntimeModelAssetNodeOccupancyResolvedEntryCount},
        {"scene_runtime_model_asset_node_occupancy_brief",
         realRendererPreviewDiagnostics.sceneRuntimeModelAssetNodeOccupancyBrief},
        {"scene_runtime_model_asset_node_occupancy_occupancy_brief",
         realRendererPreviewDiagnostics.sceneRuntimeModelAssetNodeOccupancyOccupancyBrief},
        {"scene_runtime_model_asset_node_occupancy_value_brief",
         realRendererPreviewDiagnostics.sceneRuntimeModelAssetNodeOccupancyValueBrief},
        {"scene_runtime_model_asset_node_occupancy_registry_state",
         realRendererPreviewDiagnostics.sceneRuntimeModelAssetNodeOccupancyRegistryState},
        {"scene_runtime_model_asset_node_occupancy_registry_entry_count",
         realRendererPreviewDiagnostics.sceneRuntimeModelAssetNodeOccupancyRegistryEntryCount},
        {"scene_runtime_model_asset_node_occupancy_registry_resolved_entry_count",
         realRendererPreviewDiagnostics
             .sceneRuntimeModelAssetNodeOccupancyRegistryResolvedEntryCount},
        {"scene_runtime_model_asset_node_occupancy_registry_brief",
         realRendererPreviewDiagnostics.sceneRuntimeModelAssetNodeOccupancyRegistryBrief},
        {"scene_runtime_model_asset_node_occupancy_registry_registry_brief",
         realRendererPreviewDiagnostics
             .sceneRuntimeModelAssetNodeOccupancyRegistryRegistryBrief},
        {"scene_runtime_model_asset_node_occupancy_registry_value_brief",
         realRendererPreviewDiagnostics
             .sceneRuntimeModelAssetNodeOccupancyRegistryValueBrief},
