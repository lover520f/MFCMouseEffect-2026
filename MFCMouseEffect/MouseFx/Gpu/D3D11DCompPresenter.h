...
struct D3D11DCompPresenterStatus {
    ...
    bool controlVisibleTrialOnceFilePresent = false;
    bool controlVisibleTrialOnceFileConsumed = false;
    bool controlVisibleTrialDowngradedByMultiMonitor = false;
    ...
    bool trialFrameUploadEnabled = false;
...
public:
    ...
    bool ShouldAttemptTakeover(bool holdNeon3dActive) const;
    std::string GetTakeoverFastGuardReason(bool holdNeon3dActive) const;
