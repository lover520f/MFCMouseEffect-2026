...
- 架构整理：`docs/architecture/wasm-plugin-compatibility.zh-CN.md`（WASM 插件 ABI/manifest 兼容策略）
- 架构整理：`docs/architecture/wasm-plugin-troubleshooting.zh-CN.md`（WASM 插件诊断字段与排错流程）
