...
Generated: 2026-03-23T08:59:07.330Z
...
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~14225 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~12989 tok
...
- `docs/ops/manual-commands.md` -> ~4725 tok
- `docs/agent-context/current.md` -> ~4719 tok
