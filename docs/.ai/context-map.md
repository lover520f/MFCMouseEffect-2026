...
Generated: 2026-03-23T14:19:12.422Z
...
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~15335 tok
...
- `docs/ops/manual-commands.md` -> ~6084 tok
- `docs/refactoring/phase-roadmap-macos-m1-status.md` -> ~5868 tok
- `docs/agent-context/current.md` -> ~5311 tok
