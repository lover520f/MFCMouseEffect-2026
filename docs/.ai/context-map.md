...
Generated: 2026-03-23T11:23:39.314Z
...
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~15365 tok
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~14838 tok
...
- `docs/ops/manual-commands.md` -> ~5503 tok
- `docs/agent-context/current.md` -> ~5098 tok
