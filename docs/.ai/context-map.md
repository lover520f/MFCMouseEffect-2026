...
Generated: 2026-03-23T07:56:04.776Z
...
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~13857 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~11911 tok
...
- `docs/agent-context/current.md` -> ~4966 tok
- `docs/ops/manual-commands.md` -> ~4523 tok
