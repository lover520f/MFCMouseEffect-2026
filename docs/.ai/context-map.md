...
Generated: 2026-03-24T01:57:33.577Z
...
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~16833 tok
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~15964 tok
...
- `docs/ops/manual-commands.md` -> ~6623 tok
- `docs/agent-context/current.md` -> ~5875 tok
