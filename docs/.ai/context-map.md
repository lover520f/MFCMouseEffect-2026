...
Generated: 2026-03-23T09:26:22.722Z
...
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~14507 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~13751 tok
...
- `docs/ops/manual-commands.md` -> ~4887 tok
- `docs/agent-context/current.md` -> ~4864 tok
