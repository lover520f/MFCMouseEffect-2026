...
Generated: 2026-03-23T09:19:30.086Z
...
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~14414 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~13507 tok
...
- `docs/ops/manual-commands.md` -> ~4833 tok
- `docs/agent-context/current.md` -> ~4830 tok
