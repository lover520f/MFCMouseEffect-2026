...
Generated: 2026-03-22T01:15:34.923Z
...
- `docs/architecture/windows-mouse-companion-phase1-plan.md` -> ~6027 tok
- `docs/refactoring/phase-roadmap-macos-m1-status.md` -> ~5868 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~5235 tok
- `docs/agent-context/current.md` -> ~4890 tok
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~4732 tok
