...
Generated: 2026-03-23T07:49:51.059Z
...
- `docs/ops/windows-mouse-companion-manual-checklist.md` -> ~13660 tok
- `docs/architecture/windows-mouse-companion-real-renderer-contract.md` -> ~11679 tok
...
- `docs/agent-context/current.md` -> ~4841 tok
- `docs/ops/manual-commands.md` -> ~4485 tok
