...
- Issues: `docs/issues/mouse-action-indicator-overlay.md` (add cursor-adjacent mouse action indicator with click/double/triple/wheel animation, relative/absolute positioning, and Web settings integration)
