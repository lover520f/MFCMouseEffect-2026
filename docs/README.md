...
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage19_single_lock_trial_submit.md` (merge trial-enabled check and trial submit into single-lock presenter call)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage20_takeover_block_reason.md` (expose explicit takeover block reason and trial upload gate state in web diagnostics)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage21_takeover_attempt_fast_skip.md` (skip takeover trial call on frame-loop start when takeover cannot run)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage22_not_attempted_snapshot_sync.md` (write fresh not-attempted trial snapshot when fast guard skips takeover)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage23_attempt_guard_state.md` (expose takeover attempt guard-open state in web diagnostics)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage24_control_file_presence.md` (expose takeover control file presence flags and add one-shot takeover enable file)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage25_visible_trial_once.md` (add one-shot visible-trial takeover trigger and related diagnostics)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage26_visible_trial_frame_upload.md` (keep trial frame uploads active after visible-trial ready fallback layered)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage27_defer_once_consumption.md` (consume one-shot takeover files only when real attempt starts)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage28_multimon_trial_mirror_fix.md` (fix multi-monitor mirrored output by uploading only bound trial host surface)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage29_hold_neon3d_trial_gate.md` (gate trial uploads to hold_neon3d lifecycle for single-effect full-chain validation)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage30_hold_trial_clear_on_end.md` (send one clear upload after hold end to remove stale secondary-monitor trial image)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage31_hold_clear_multiframe.md` (clear trial layer across multiple frames after hold end to remove residual artifacts)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage32_visible_once_multimon_downgrade.md` (auto-downgrade visible once trial on multi-monitor to avoid secondary-screen artifacts)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage33_visible_trial_on_multimon_guard.md` (ignore persistent visible-trial file on multi-monitor for safer default behavior)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage34_multimon_downgrade_state.md` (expose explicit multi-monitor visible-trial safety-downgrade state)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage35_hold_active_takeover_gate.md` (gate visible-trial takeover attempts to active hold_neon3d lifecycle and expose exact fast-guard reason)
- Issues: `docs/issues/gpu_route_switch_dawn_to_d3d11_dcomp_stage36_hold_edge_takeover_retry.md` (retry takeover fast-guard check on hold_neon3d activation edge to avoid missed attempt timing)
