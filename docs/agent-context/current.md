...
- POSIX dual-lane guardrail exists:
  ...
  - macOS input-indicator overlay now splits show-plan computation into dedicated module (`MacosInputIndicatorOverlay.ShowPlan.*`), reducing lifecycle/presentation vs plan-calculation coupling while preserving indicator overlay contracts
