...
- POSIX dual-lane guardrail exists:
  ...
  - macOS click pulse core is now split by concern (`render plan` + `layers/animation` + orchestration entry), reducing click-effect render coupling while preserving effect contracts
