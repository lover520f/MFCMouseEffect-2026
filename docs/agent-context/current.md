...
- POSIX dual-lane guardrail exists:
  ...
  - macOS app-catalog scan workflow now splits root traversal/filtering into dedicated enumerate helper (`MacosApplicationCatalogScanWorkflow.RootScan.Enumerate.mm`) while keeping root-scan file focused on resolve/upsert orchestration
